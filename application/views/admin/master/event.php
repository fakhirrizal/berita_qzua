...
<div class="card shadow mb-4">
  <div class="card-header py-3">
	...
	<a href="<?=base_url('admin_side/tambah_event');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data <i class="fa fa-plus"></i></a>
  </div>
  <div class="card-body">
