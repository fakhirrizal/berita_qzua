...
<div class="card shadow mb-4">
  <div class="card-header py-3">
	...
	<!-- <a href="<?=base_url('admin_side/tambah_kategori_berita');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Tambah Data <i class="fa fa-plus"></i></a> -->
  </div>
  <div class="card-body">
			...
			<table class="table table-striped table-bordered" id="tbl">
				<thead>
					<tr>
						...
						<th style="text-align: center;"> In Response To </th>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function(){
				$('#tbl').dataTable({
					...
					"bProcessing": true,
					"ajax" : {
						url: "<?= site_url('admin/Master/json_komen'); ?>"
					},
					"aoColumns": [
