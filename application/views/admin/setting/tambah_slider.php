			...
			<div class="d-flex align-items-center">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb m-0 p-0">
						<li class="breadcrumb-item"><a href="#">Add New Slider Data</a>
						</li>
					</ol>
				</nav>
			</div>
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="form-body">
                            <div class="form-group form-md-line-input has-danger">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Type something" required>
                            </div>
                            ...
                            <div class="form-group form-md-line-input has-danger">
                                <label class="control-label" for="form_control_1">Image <span class="required"> * </span></label>
