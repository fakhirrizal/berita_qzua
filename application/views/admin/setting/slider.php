	...
	<div class="card-group">
		<div class="card border-right">
			...
			<div class="card-header py-3">
				...
				<a href="<?=base_url('admin_side/tambah_slider');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Add Data <i class="fa fa-plus"></i></a>
			</div>
			<div class="card-body">
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"bProcessing": true,
								"ajax" : {
									url:"<?= site_url('admin/Setting/json_slider'); ?>"
								},
								"aoColumns": [
											{ mData: 'no', sClass: "alignCenter" },
											{ mData: 'title', sClass: "alignCenter" },
											{ mData: 'description', sClass: "alignCenter" } ,
