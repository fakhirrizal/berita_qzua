			...
			<div class="d-flex align-items-center">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb m-0 p-0">
						<li class="breadcrumb-item"><a href="#">Cover Image</a>
						</li>
					</ol>
				</nav>
			</div>
	...
	<div class="card-group">
		<div class="card border-right">
			...
			<!-- <div class="card-header py-3">
				<a href="<?=base_url('admin_side/tambah_cover');?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Add Data <i class="fa fa-plus"></i></a>
			</div> -->
			<div class="card-body">
						...
						<table class="table table-striped table-bordered" id="tbl">
							<thead>
								<tr>
									...
									<th style="text-align: center;"> Page Menu </th>
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							$('#tbl').dataTable({
								...
								"bProcessing": true,
								"ajax" : {
									url:"<?= site_url('admin/Setting/json_cover'); ?>"
								},
								"aoColumns": [
											{ mData: 'no', sClass: "alignCenter" },
											{ mData: 'page', sClass: "alignCenter" } ,
											{ mData: 'title', sClass: "alignCenter" },
											{ mData: 'image', sClass: "alignCenter" },
											{ mData: 'action' }
										]
							});
