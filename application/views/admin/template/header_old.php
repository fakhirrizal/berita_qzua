...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav gradienwarna sidebar sidebar-dark accordion" id="accordionSidebar">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url().'admin_side'; ?>">
	  ...
	  <li class="nav-item <?php if($parent=='setting'){echo'active';}else{echo'';} ?>">
        ...
        <div id="collapseThree" class="collapse <?php if($parent=='setting'){echo'show';}else{echo'';} ?>" aria-labelledby="headingThree" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?php if($child=='slider'){echo'active';}else{echo'';} ?>" href="<?php echo site_url('admin_side/slider'); ?>">Slider</a>
            <a class="collapse-item <?php if($child=='cover'){echo'active';}else{echo'';} ?>" href="<?php echo site_url('admin_side/cover'); ?>">Cover Image</a>
          </div>
        </div>
	  </li>
