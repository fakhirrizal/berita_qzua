...
if(($this->session->userdata('id'))==NULL){
	...
	echo "<script>window.location='".base_url('admin_side/logout')."'</script>";
}else{
						...
						<ul class="nav navbar-nav pull-right">
							...
							<li class="dropdown dropdown-user dropdown-dark">
								...
								<ul class="dropdown-menu dropdown-menu-default">
									...
									<li>
										<a href="<?php echo site_url('admin_side/logout'); ?>">
						...
						<ul class="nav navbar-nav">
							...
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='master'){echo 'active';}else{echo '';} ?>">
								...
								<ul class="dropdown-menu pull-left">
									...
									<li class=" <?php if($child=='kategori_berita'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('admin_side/kategori_berita'); ?>" class="nav-link nav-toggle ">
											<i class="icon-pin"></i> Kategori Berita
										</a>
									</li>
