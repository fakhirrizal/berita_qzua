...
<html lang="en">
<head>
	<title>Queensland Zhejiang United Association Inc. - <?= $data_berita->judul; ?></title>
	<meta charset="utf-8">
...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="post_category trans_200"><a href="<?= base_url().'kategori/News'; ?>" class="trans_200">News</a></div>
			<div class="post_title"><?= $data_berita->judul; ?></div>
		</div>
	</div>
				...
				<div class="col-lg-9">
					<div class="post_content">
						...
						<div class="post_panel post_panel_top d-flex flex-row align-items-center justify-content-start">
							<?php
							$img_src = '';
							if($data_berita->photo==NULL OR $data_berita->photo==''){
								$img_src = base_url().'assets/default-profile.png';
							}else{
								$img_src = base_url().'data_upload/photo_profile/'.$data_berita->photo;
							}
							?>
							<div class="author_image"><div><img src="<?= $img_src; ?>" alt=""></div></div>
							<div class="post_meta"><a href="#"><?= $data_berita->fullname; ?></a><span><?= date("M d, Y", strtotime($data_berita->created_at)).' at '.date("h:i a", strtotime($data_berita->created_at)); ?></span></div>
						...
						<div class="post_body">
							<p class="post_p"><?= $data_berita->berita; ?></p>
						...
						<!-- <div class="post_panel bottom_panel d-flex flex-row align-items-center justify-content-start">
							<div class="author_image"><div><img src="<?= base_url(); ?>assets/images/author.jpg" alt=""></div></div>
						...
						<div class="similar_posts">
							<div class="grid clearfix">
								...
								<div class="card card_small_with_image grid-item">
									...
									<div class="card-body">
										<div class="card-title card-title-small"><a href="<?= base_url(); ?>news_detail/<?= $value->id_berita; ?>"><?= $value->judul; ?></a></div>
									...
									<div class="col-xl-8">
										<div class="post_comment_form_container">
											<form action="<?= base_url(); ?>save_comment" method='post'>
												...
												<input type="text" class="comment_input comment_input_name" name='text' placeholder="Your Name" required="required">
												<input type="email" class="comment_input comment_input_email" name='email' placeholder="Your Email" required="required">
							...
							<div class="comments">
								...
								?>
								<div class="comments_title">Comments <span>(<?= number_format(count($data_komen),0); ?>)</span></div>
								<div class="row">
									<div class="col-xl-8">
										<div class="comments_container">
											<ul class="comment_list">
												<!-- <li class="comment">
													<div class="comment_body">
														<div class="comment_panel d-flex flex-row align-items-center justify-content-start">
															<div class="comment_author_image"><div><img src="<?= base_url(); ?>assets/images/comment_author_1.jpg" alt=""></div></div>
															<small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>
													...
													<ul class="comment_list">
														<li class="comment">
															<div class="comment_body">
																<div class="comment_panel d-flex flex-row align-items-center justify-content-start">
																	<div class="comment_author_image"><div><img src="<?= base_url(); ?>assets/images/comment_author_2.jpg" alt=""></div></div>
																	<small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>
																	<button type="button" class="reply_button ml-auto">Reply</button>
																</div>
																<div class="comment_content">
												...
												<li class="comment">
													<div class="comment_body">
														<div class="comment_panel d-flex flex-row align-items-center justify-content-start">
															<div class="comment_author_image"><div><img src="<?= base_url(); ?>assets/default-profile.png" width='100%' alt=""></div></div>
															<small class="post_meta"><a href="#"><?= $value->nama; ?></a><span><?= date("M d, Y", strtotime($value->created_at)).' at '.date("h:i a", strtotime($value->created_at)); ?></span></small>
															<button type="button" class="reply_button ml-auto detaildata" id="<?= md5($value->id_komentar_berita); ?>">Reply</button>
														</div>
														<div class="comment_content">
															<p><?= $value->komentar; ?></p>
														</div>
														...
														<ul class="comment_list">
															<li class="comment">
																<div class="comment_body">
																	<div class="comment_panel d-flex flex-row align-items-center justify-content-start">
																		<div class="comment_author_image"><div><img src="'.base_url().'assets/default-profile.png" width="100%" alt=""></div></div>
																		<small class="post_meta"><a href="#">'.$row->nama.'</a><span>'.date("M d, Y", strtotime($row->created_at)).' at '.date("h:i a", strtotime($row->created_at)).'</span></small>
																	</div>
																	<div class="comment_content">
																		<p>'.$row->komentar.'</p>
																	</div>
